...
public class User
{
    ...
    public static User Create(string name, string cpf, string motherName, DateTime dateBirth, DateTime dateOfCreation, string language) =>
        new(0, name, cpf, motherName, dateBirth, DateTime.Now, language, true);
